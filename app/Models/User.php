...
class User extends Authenticatable
{
    ...
    protected $fillable = [
        'name','first_name','last_name', 'email','password','state_id','district_id','location','account_verification_status','status','reason_id','profile_image','deleted_at','created_at','updated_at'
    ];
