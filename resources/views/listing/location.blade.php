				...
				<div class="row justify-content-center">
					...
					<div class="col-md-9 mt-4 mt-sm-0 pl-4 pr-4">
						<form id="lis_location" method="post" action="{{ url('listing/' . $result->id . '/' . $step) }}" accept-charset='UTF-8'>
							{{ csrf_field() }}
							<div class="col-md-12  mt-4 pb-5  pl-4 pl-sm-0 pr-4 pr-sm-0 " style="border:1px solid #7cb342;">
								...
								<div class="row mt-4">
									<div class="col-md-12 pl-5 pr-5 prop-label">
								...
								<div class="row mt-4">
									<div class="col-md-6 mt-4 pl-5 pr-5 prop-label">
							...
							<div class="col-md-12 p-0 mt-4 mb-5 ">
								<div class="row justify-content-between">
									<div class="mt-4">
										<a href="{{ url('listing/' . $result->id . '/description') }}" class="back-btn">
											{{ __('Back') }}
										</a>
									</div>
