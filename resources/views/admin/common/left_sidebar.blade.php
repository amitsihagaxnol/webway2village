...
<aside class="main-sidebar" >
	...
	<ul class="sidebar-menu">
		...
		@endif
		@if (Helpers::has_permission(Auth::guard('admin')->user()->id, 'customers'))
			<li class="{{ (Route::current()->uri() == 'admin/farm-house-owners') || (Route::current()->uri() == 'admin/add-farm-house-owner') || (Route::current()->uri() == 'admin/edit-farm-house-owner/{id}') || (Route::current()->uri() == 'admin/customer/properties/{id}')  || (Route::current()->uri() == 'admin/customer/bookings/{id}') || (Route::current()->uri() == 'admin/customer/payouts/{id}')  || (Route::current()->uri() == 'admin/customer/payment-methods/{id}') || (Route::current()->uri() == 'admin/customer/wallet/{id}')  ? 'active' : '' }}"><a href="{{ url('admin/farm-house-owners') }}"><i class="fa fa-users"></i><span>Farm House Owners</span></a></li>
		@endif

		@if (Helpers::has_permission(Auth::guard('admin')->user()->id, 'properties'))
			<li class="{{ (Route::current()->uri() == 'admin/properties') || (Route::current()->uri() == 'admin/add-properties') || (Route::current()->uri() == 'admin/listing/{id}/{step}') ? 'active' : ''  }}"><a href="{{ url('admin/properties') }}"><i class="fa fa-home"></i><span>Farm Houses</span></a></li>
		@endif

        @if (Helpers::has_permission(Auth::guard('admin')->user()->id, 'properties'))
			<li class="{{ (Route::current()->uri() == 'admin/village-properties') || (Route::current()->uri() == 'admin/village-add-properties') || (Route::current()->uri() == 'admin/village-listing/{id}/{step}') ? 'active' : ''  }}"><a href="{{ url('admin/village-properties') }}"><i class="fa fa-home"></i><span>Village Farm Houses</span></a></li>
		@endif
		...
		@if (Helpers::has_permission(Auth::guard('admin')->user()->id, 'manage_pages'))
		   <li class="{{ (Route::current()->uri() == 'admin/contact')  ? 'active' : ''  }}"><a href="{{ url('admin/contact') }}"><i class="fa fa-puzzle-piece"></i><span>Contact</span></a></li>
		   <li class="{{ (Route::current()->uri() == 'admin/help')  ? 'active' : ''  }}"><a href="{{ url('admin/help') }}"><i class="fa fa-puzzle-piece"></i><span>Help Center</span></a></li>
        ...
        <li class="{{ (Route::current()->uri() == 'admin/cache-clear') ? 'active' : ''  }}"><a href="{{ url('admin/cache-clear') }}"><i class="fa fa-trash-o"></i><span>Cache Clear</span></a></li>
        	@if (Helpers::has_permission(Auth::guard('admin')->user()->id, 'activity'))
				<li class="{{ (Request::segment(2) == 'activity') ? 'active' : ''  }}"><a href="{{ url('admin/activity') }}"><i class="fa fa-gears"></i><span>Activity</span></a></li>
			@endif
			@if (Helpers::has_permission(Auth::guard('admin')->user()->id, 'activity'))
				<li class="{{ (Request::segment(2) == 'facility') ? 'active' : ''  }}"><a href="{{ url('admin/facility') }}"><i class="fa fa-gears"></i><span>Facility</span></a></li>
			@endif
		...
		@endif
			...
			<li class="treeview">
				<a href="#">
				<i class="fa fa-bar-chart-o"></i> <span>Master Data</span><i class="fa fa-angle-left pull-right"></i>
				</a>
				<ul class="treeview-menu">
				<li class=""><a href="#"><span>Property Type</span></a></li>
				<li class=""><a href="#"><span>Farm Type</span></a></li>
