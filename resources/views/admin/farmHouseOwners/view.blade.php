	...
	<div class="content-wrapper">
		<section class="content-header">
			<h1>Farm House Owners<small>Control panel</small></h1>
					...
					<div class="box">
						<div class="box-header">
							...
							@if (Helpers::has_permission(Auth::guard('admin')->user()->id, 'add_customer'))
								<div class="pull-right"><a class="btn btn-success f-14" href="{{ url('admin/add-farm-house-owner') }}">Add Farm House Owner</a></div>
							@endif
						</div>
