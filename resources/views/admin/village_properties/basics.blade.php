                                                                ...
                                                                <td>
                                                                    <select name="room_type[]" class="form-control">
                                                                        @foreach($room_type as $key => $room)
                                                                            <option value="{{ $key }}"  {{ $key == $item->room_type ?? 'selected' }}>{{ $room }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                </td>
                                                                <td><input type="text" name="total[]" class="form-control numeric" value="{{ $item->total ?? '' }}" placeholder="Total"></td>
                                                                <td><input type="text" name="available[]" class="form-control numeric" value="{{ $item->available ?? '' }}" placeholder="Available"></td>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#cloneOption').click(function() {
                ...
                @foreach($room_type as $key => $room)
                    newRow += '<option value="{{ $key }}">{{ $room }}</option>';
                @endforeach
