    ...
    <section class="content">
        <div class="row gap-2">
            <div class="col-md-3 settings_bar_gap">
                ...
                <div class="col-md-9">
                    <form id="listing_location" method="post" action="{{ url('admin/village-listing/' . $result->id . '/' . $step) }}" class='signup-form login-form' accept-charset='UTF-8'>
                        {{ csrf_field() }}
                            ...
                            <div class="box-body">
                                ...
                                <div class="row">
                                    <div class="col-6 text-left">
                                        <a data-prevent-default="" href="{{ url('admin/village-listing/' . $result->id . '/description') }}" class="btn btn-large btn-primary f-14">Back</a>
                                    </div>
