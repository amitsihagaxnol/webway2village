						...
						<form id="google_recaptcha_api_credentials" method="post" action="{{ url('admin/settings/google-recaptcha-api-information') }}" class="form-horizontal" >
							...
							<div class="box-body">
                                <div class="form-group row mt-3 google_recaptcha_key">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="google_recaptcha_key" class="form-control f-14" id="google_recaptcha_key" placeholder="Enter Google reCaptcha Key" value="{{ settings('recaptcha_key') ?? config('vrent.reCaptchaKey') }}">
                                ...
                                <div class="form-group row mt-3 google_recaptcha_secret">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="google_recaptcha_secret" class="form-control f-14" id="google_recaptcha_secret" placeholder="Enter Google reCaptcha Secret" value="{{ settings('recaptcha_secret') ?? config('vrent.reCaptchaSecret') }}">
