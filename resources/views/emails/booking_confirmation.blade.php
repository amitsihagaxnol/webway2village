                    ...
                    <div class="row">
                        ...
                        <div class="col-12  px__5 py-3">
                            <div class="bk-details-bx">
                                <h3>Booking ID : <span>{{ $bookingDetails['bookingNo'] ?? '' }}</span></h3>
                                <h3>Booking Date : <span>{{ date('Y-m-d') }}</span></h3>
                        ...
                        <div class="col-12  px__5 py-3">
                            ...
                            <div class="mt-5 table-reponsive" style="overflow-x:auto;">
                                <table class="table table-cstm table-striped">
                                    ...
                                    <tr>
                                       <td>{{ $bookingDetails['data']['total_no_adults'] ?? '' }}</td>
                                       <td>{{ $bookingDetails['data']['total_no_children'] }}</td>
                                       <td>{{ $bookingDetails['data']['totalRooms'] }}</td>
                                       <td>{{ $roomTypeDetail->name ?? '' }}</td>
                                       <td><a href="{{ route('listing-detail.details', $bookingDetails['property']->id) }}" target="_blank">{{  $bookingDetails['property']->name ?? '' }}</a></td>
                                       <td>{{ @$location['city']->name }}, {{ @$location['state']->name }}, {{ @$location['country']->name }}</td>
                                       <td>{{ $bookingDetails['data']['check_in_date'] }}</td>
                                       <td>{{ $bookingDetails['data']['check_out_date'] }}</td>
                                    </tr>
                        ...
                        <div class="col-12 px__5 py-3">
                            <div class="policies">
                                <div class="policies-bx">
                                    <h6>{{ $bookingDetails['cancellation']->heading ?? '' }}</h6>
                                    <p>{!! $bookingDetails['cancellation']->content ?? '' !!}<p>
                                </div>
                                <div class="policies-bx mt-4 rfnd">
                                    <h6>{{ $bookingDetails['refund']->heading ?? '' }}</h6>
                                    <p >{!!$bookingDetails['refund']->content !!}</p>
                                </div>
