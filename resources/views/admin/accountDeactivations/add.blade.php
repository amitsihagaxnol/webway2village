				...
				<div class="col-lg-9 col-12">
					<div class="box box-info">
						...
						<div class="box-header with-border">
							<h3 class="box-title">Add Account Deactivation Form</h3><span class="email_status" >(<span class="text-green"><i class="fa fa-check" aria-hidden="true"></i>Verified</span>)</span>
						</div>

						<form id="add_property" method="post" action="{{ url('admin/settings/add-account-deactivation') }}" class="form-horizontal" enctype=multipart/form-data >
							{{ csrf_field() }}
							<div class="box-body">
                                <div class="form-group row mt-3 name">
                                    ...
                                    <div class="col-sm-6">
                                        <textarea name="reason" class="form-control f-14 validate_field" id="reason" placeholder="reason"></textarea>
							...
							<div class="box-footer">
								...
								<a class="btn btn-danger f-14" href="{{ url('admin/settings/activity-type') }}">Cancel</a>
