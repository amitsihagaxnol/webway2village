        ...
        <div class="row gap-2">
            ...
            <div class="col-md-9">
                <div class="box box-info">
                    <div class="box-body">
                        <form method="post" action="{{ url('admin/village-listing/' . $result->id . '/' . $step) }}" class='signup-form login-form' accept-charset='UTF-8' enctype='multipart/form-data'>
                            {{ csrf_field() }}
                            <div class="row p-3">
                                <div class="col-md-12">
                                    <h4> Activities</h4>
                                ...
                                <div class="col-12 mt-3">
                                    <div class="row">
                                        <div class="col-6 text-left">
                                            <a data-prevent-default="" href="{{ url('admin/village-listing/' . $result->id . '/facilities') }}" class="btn btn-large btn-primary f-14">Back</a>
                                        </div>
