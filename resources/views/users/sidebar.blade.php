...
/*.li-a{*/
/*      border-bottom :1px solid #7cb3423e !important;*/
/*}*/

 
 </style>
<div class="col-lg-2 p-0  d-none d-lg-block overflow-hidden mt-m-30">
	<div class="main-panel mt-5 h-100 bg-clr">
		<div class="mt-2">
			<ul class="list-group list-group-flush pl-3 " >
			    <a class="text-color font-weight-500 mt-1 li-a" href="{{ url('dashboard') }}">
			    ...
			    <a class="text-color font-weight-500 mt-1 li-a" href="{{ url('users/profile') }}">
				...
				@if(Auth::user()->role!="customer")
    			    <a class="text-color font-weight-500 mt-1 li-a" href="{{ url('properties') }}">
    					<li class="list-group-item vbg-default-hover pl-25 border-0 text-15 p-4  {{ (request()->is('properties')) ? 'active-sidebar' : '' }}">
    						<i class="fa-solid fa-house mr-3 text-18 align-middle"></i>
    					    Farm Houses
    					</li>
    				</a>
			   
			    <a class="text-color font-weight-500 mt-1 li-a" href="#">
					<li class="list-group-item vbg-default-hover pl-25 border-0 text-15 p-4   {{ (request()->is('dashboard')) ? '' : '' }}">
							<i class="far fa-list-alt mr-3 text-18 align-middle"></i>
						Manage Village Farm House
					</li>
				</a>
				 @endif

				<a class="text-color font-weight-500 mt-1 li-a" href="{{ url('inbox') }}">
				...
				<a class="text-color font-weight-500 mt-1 li-a" href="{{ url('my-bookings') }}">
				...
				<a class="text-color font-weight-500 mt-1 li-a" href="{{ url('trips/active') }}">
                ...
                <a class="text-color font-weight-500 mt-1 li-a" href="{{ url('user/favourite') }}">
				...
				<a class="text-color font-weight-500 mt-1 li-a" href="{{ url('users/payout-list') }}">
				...
				<a class="text-color font-weight-500 mt-1 li-a" href="{{ url('users/transaction-history') }}">
				...
				<a class="text-color font-weight-500 li-a" data-toggle="collapse" href="#collapseReviews" role="button" aria-expanded="true" aria-controls="collapseReviews" id="reviewIcon">
					<li class="list-group-item vbg-default-hover pl-25 border-0 text-15 p-4 sidebr-list {{ (request()->is('users/reviews'))  || (request()->is('users/reviews_by_you')) || (request()->is('reviews/edit/*'))  ? 'active-sidebar' : '' }}">
				...
				<a class="text-color font-weight-500 mt-1 li-a" href="{{ url('logout') }}">
