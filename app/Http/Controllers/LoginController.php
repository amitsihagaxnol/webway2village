...
use App\Models\{PasswordResets, Settings, User, UserDetails, UsersVerification ,State,
    District};
...
class LoginController extends Controller
{
    ...
    public function mainLogin()
    {
        ...
        return view('login.main-login-view');
    }
    ...
    public function customerIndex(){
        $data['social'] = Settings::getAll()->where('type','social')->pluck('value','name');
        return view('login.customer_view', $data);
    }
    ...
    public function customerSignup(Request $request)
    {
        ...
        $data['social'] = Settings::getAll()->where('type','social')->pluck('value','name');
        return view('home.customer_signup_login', $data);
    }
    ...
    public function verifyEmail(Request $request, $encoded_email)
    {
        ...
        if ($user->hasVerifiedEmail()) {
            ...
            return Redirect::to('/')->with('info', 'Email is already verified.');
        }

        // Verify the user's email
        $user->markEmailAsVerified();

        // Optionally, log the user in after email verification
        Auth::login($user);
