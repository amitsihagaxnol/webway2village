...
<div class="at-homefilter margin-top-85" style="padding-top: 50px;">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        ...
                        <form action="{{ url('village_farm_house') }}" method="GET">
                            <div class="inner-card">
                                <div class="row align-items-center">
                                    <div class="col-md-9">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 position-relative" class="home-wid-bx" style="border-right:1px solid #7cb342; display:flex; justify-content:flex-start; align-items:flex-start; flex-direction:column; ">
                                                <div style="width:100%; height:100%; background:#fff; border-radius:4px; padding:10px;">
                                                     <label id="CheckIn"  style="margin:0;">
                                            ...
                                            <div class="col-md-4 position-relative" class="home-wid-bx" style=" display:flex; justify-content:flex-start; align-items:flex-start; flex-direction:column;">
                                                <div style="width:100%; height:100%; background:#fff; border-radius:4px; padding:10px;">
                                                    <label id="Guests" style="margin:0;">
                                    ...
                                    <div class="col-md-3 d-flex justify-content-between align-items-center">
                                        ...
                                        <a class="btn btn-main float-right n-hvr" style="width:100%;height:55px; border-radius:5px; font-size:15px; padding:0; display:flex; justify-content:center; align-items:center;"  href="{{ url('village_farm_house') }}">Reset</a>
                                    </div>
                                </div>
                            </div>
                        </form>
       ...
       <div class="at-Listing pb-5">

        <div class="container">
             <div class="farm-house w-100 pd" >
               <div class="d-flex w-100  justify-content-between align-items-center">
                        <div class="df-bx w-50">
                            <h2 ><a href="{{ url('farm_house') }}">Farm House</a></h2>
                        <h2 class="df-bx-h20active"><a href="{{ url('village_farm_house') }}">Village Farm House</a></h2>
                        </div>
                    ...
                    @if(count($data['properties'])>0)
                        ...
                        <div class="col-lg-4">
                            <div class="Listings_card" >
                                <div class="card">
                                    <a href="{{route('village.listing-detail.details',['id'=>$property->id])}}">
