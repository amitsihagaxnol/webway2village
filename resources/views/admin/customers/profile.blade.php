                    ...
                    <div class="box">
                       ...
                       <div class="row">
                            ...
                            <div class="col-md-9 align-self-center">
                                ...
                                <form name="ajax_upload" method="post" id="ajax_upload" enctype="multipart/form-data" action="{{ url("admin/customer/profile/" . $user?->id) }}" accept-charset="UTF-8" novalidate="novalidate">
