...
@section('validate_script')
    ...
    <script type="text/javascript">
       ...
       var selectedRecaptchaPlace = "{{ settings('recaptcha_preference') ?? NULL }}";
       var reCaptchaKey = "{{ settings('recaptcha_key') ?? NULL }}";
       var reCaptchaSecret = "{{ settings('recaptcha_secret') ?? NULL }}";
