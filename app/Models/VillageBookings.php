...
class VillageBookings extends Model
{
    use HasFactory;
    use SoftDeletes;

    protected $table = 'village_bookings';
    ...
    {
        return $this->hasMany('App\Models\VillageBookingDetails', 'booking_id', 'id');
    }
    ...
    {
        $bookings = VillageBookings::join('properties', function ($join) {
