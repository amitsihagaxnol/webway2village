                               ...
                               {{ csrf_field() }}
					          	<div class="col-md-12 p-0 mt-4  pb-4 m-0" style="border:1px solid #7cb342;">
									<div class="form-group col-md-12 main-panelbg pb-3 pt-3 pl-4">
											<h4 class="text-16 font-weight-700"> Sustainable Farm Practicess</h4>
									</div>
                                    ...
                                    @if($sustainable_practices->isNotEmpty())
                                        ...
                                        @foreach($sustainable_practices as $practice)
                                           ...
                                           <div class="col-sm-1 sustainable-count d-flex justify-content-center align-items-center">
                                                  {{$i}}
                                           </div>
                                            ...
                                            <div class="col-sm-5 col-md-5">
                                               <div class="form-group prop-label">
                									<label class="form-label">Sustainable Farming Practice  <span class="text-danger">*</span></label>
                                            ...
                                            <div class="col-sm-5 col-md-5">
                                                <div class="form-group prop-label">
                                                <label class="form-label">Sustainable Details<span class="text-danger">*</span></label>
                                                   <textarea class="form-control mb-4 test-data" name="sustainable_farming_details[]"   rows="3" style="height:43px !important" value="{{$practice['sustainable_practice']->description}}">{{$practice['sustainable_practice']->description}}</textarea>
                                              </div>
                                            </div>
                                        ...
                                        <div class="row  sustainable-original-fields">
                                           <div class="col-sm-1 sustainable-count d-flex justify-content-center align-items-center">
                                            ...
                                            <div class="col-sm-5 col-md-5">
                                                <div class="form-group prop-label">
                                                <label class="form-label">Sustainable Details<span class="text-danger">*</span></label>
                                                   <textarea class="form-control mb-4 test-data" name="sustainable_farming_details[]"   rows="3" style="height:43px !important"></textarea>
                                              </div>
                                            </div>
								...
								<div class="col-md-12 mt-4 p-0 mb-5">
									<div class="row justify-content-between">
										<div class="mt-4">
											<a href="{{ url('listing/' . $result->id . '/type_of_organic_products') }}" class="back-btn">
												{{ __('Back') }}
											</a>
										</div>
