...
<div class="content-wrapper">
    <section class="content-header">
        <h1>Farm House Owners<small>Add Farm House Owner</small></h1>
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
            <div class="box">
                <form class="form-horizontal" action="{{ url('admin/add-farm-house-owner') }}" id="add_customer" method="post" name="add_customer" accept-charset='UTF-8'>
                    {{ csrf_field() }}
                    <div class="box-body">
                        ...
                        <div class="form-group mt-3 row">
                            <label for="exampleInputPassword1" class="control-label col-sm-3 mt-2 fw-bold">Phone <span class="text-danger">*</span></label>
                            <div class="col-sm-8">
                        ...
                        <div class="form-group mt-3 row">
                            <label for="exampleInputPassword1" class="control-label col-sm-3 mt-2 fw-bold">Account Verification Status <span class="text-danger">*</span></label>
                            <div class="col-sm-8">
                            <select class="form-control f-14" name="account_verification_status" id="account_verification_status">
                        ...
                        <div class="form-group mt-3 row">
                            <label for="exampleInputPassword1" class="control-label col-sm-3 mt-2 fw-bold">Profile</label>
                            <div class="col-sm-8">
