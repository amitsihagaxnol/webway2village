	...
	<div class="content-wrapper">
		<section class="content-header">
			<h1>Facility<small>Facility</small></h1>
				...
				<div class="col-xs-12">
					<div class="box">
						<div class="box-header">
							<h3 class="box-title">Facility Management</h3>
							@if (Helpers::has_permission(Auth::guard('admin')->user()->id, 'add_customer'))
								<div class="pull-right"><a class="btn btn-success f-14" href="{{ url('admin/add-facility') }}">Add Facility</a></div>
							@endif
						</div>
