...
@section('main')
	<input type="hidden" id="front_date_format_type" value="{{ Session::get('front_date_format_type') }}">
        ...
        <!-- Header End -->
        <div class="at-tittel_banner " style="background-image:linear-gradient(0deg, rgba(34,34,34,0.4823179271708683) 0%, rgba(34,34,34,0.4599089635854342) 100%), url('http://web.way2village.in/public/images/cms/banner/{{$about->image}}');">
            <div class="container">
                <div class="row">
        ...
        <div class="at-term mb-3">
            <div class="container">
                <div class="row ">
                    <div class="col-lg-5 d-flex justify-content-center align-items-center">
                        <div style="width:100%; height:400px; margin-top:60px;">
                            
                       <img src="{{ asset('public/images/cms/feature_image/' . $about->feature_image) }}" style="width: 100%; height: 100%; border-radius:10px; object-fit:cover;">
                        </div>
