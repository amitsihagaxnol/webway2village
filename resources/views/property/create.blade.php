...
<div class="mb-4 margin-top-85">
	<div class="row m-0">
		...
		<div class="col-md-10  min-height">
			<div class="main-panel m-4 list-background " style="border-radius: 15px;
    box-shadow: rgba(99, 99, 99, 0.2) 0px 2px 8px 0px;
    backdrop-filter: blur(7.8px);
    -webkit-backdrop-filter: blur(7.8px);
    border: 2px solid #7cb342;">
				<h3 class="text-center mt-5 text-24 font-weight-700" style="color:#7cb342;">{{ __('List Your Space') }}</h3>
					...
					<div class="row p-4">
						<div class="col-md-6">
							<div class="form-group mt-4">
								<label for="exampleInputEmail1" style="font-size:12px; color:#7cb342;">{{ __('Home Type') }}</label>
						...
						<div class="col-md-6">
							<div class="form-group mt-4">
								<label for="exampleInputEmail1" style="font-size:12px; color:#7cb342;">{{ __('Room Type') }}</label>
						...
						<div class="col-md-6">
							<div class="form-group mt-4">
								<label for="exampleInputEmail1" style="font-size:12px; color:#7cb342;">{{ __('Accommodates') }}</label>
						...
						<div class="col-md-6">
							<div class="form-group mt-4">
								<label for="exampleInputPassword1" style="font-size:12px; color:#7cb342;">{{ __('City') }} <span class="text-danger">*</span></label>
						...
						<div class="col-md-12">
							<div class="float-right">
								<button type="submit" class="w2v-lgn-btn w-100" id="btn_next"> <i class="spinner fa fa-spinner fa-spin d-none" ></i>
