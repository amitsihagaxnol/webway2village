            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box">
                        ...
                        <form class="form-horizontal" action="{{ url('admin/edit-farm-house-owner') }}/{{ $user->id }}"
                        ...
                        <div class="form-group mt-3 row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="location" value="{{$user->location}}" id="location" placeholder="">
                            </div>
                        </div>
                              <div class="form-group mt-3 row">
                            ...
                            <select class="form-control f-14" name="account_verification_status" id="account_verification_status">
                                <option value="pending" @if($user->account_verification_status=="pending") selected @endif>Pending</option>
                                <option value="approved" @if($user->account_verification_status=="approved") selected @endif>Approved</option>
                            </select>
                            </div>
                        </div>
