...
class PaymentController extends Controller
{
    ...
    public function store($data)
    {
        ...
        $booking->service_charge    = $service_fee  = Common::convert_currency('', $currencyDefault->code, $data['price_list']->service_fee);
        $booking->host_fee          = $host_fee     = Common::convert_currency('', $currencyDefault->code, $data['price_list']->host_fee);
        $booking->total             = $total_amount = Common::convert_currency('', $currencyDefault->code, $data['price_list']->total);
