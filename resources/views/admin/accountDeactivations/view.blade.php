				...
				<div class="col-xs-12">
					<div class="box">
						<div class="box-header">
							<h3 class="box-title">Account Deactivation Management</h3>
							@if (Helpers::has_permission(Auth::guard('admin')->user()->id, 'add_customer'))
								<div class="pull-right"><a class="btn btn-success f-14" href="{{ url('admin/settings/add-account-deactivation') }}">Add Account Deactivation</a></div>
							@endif
						</div>
