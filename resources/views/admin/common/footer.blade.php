<footer class="main-footer f-14 d-flex justify-content-center align-items-center">
	<!--<div class="pull-right hidden-xs">-->
	<!--	{{ __(appVersion()) }}-->
	<!--</div>-->
		<!--<strong>Copyright &copy; 2016-{{ date('Y') }} <a href="#">{{ siteName() }}</a>.</strong> All rights reserved.-->
		<strong>Copyright &copy; 2024  <a href=""><span class="" style="color:#7cb342;">@Way2Village</span></a></strong>
</footer>
