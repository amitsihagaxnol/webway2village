					...
					<div class="row justify-content-center">
						...
						<div class="col-md-9 mt-4 mt-sm-0 pl-4 pr-4">
							<form id="lis_pricing" method="post" action="{{ url('listing/' . $result->id . '/' . $step) }}" accept-charset='UTF-8'>
								{{ csrf_field() }}
								<div class="form-row mt-4   pb-4 m-0" style="border:1px solid #7cb342;">
									<div class="form-group col-md-12 main-panelbg pb-3 pt-3 pl-4">
										<h4 class="text-16 font-weight-700">{{ __('Base price') }}</h4>
									</div>

									<div class="form-group col-lg-6 pl-5 pr-5 prop-label">
								...
								<div class="mt-4  pb-4 m-0" style="border:1px solid #7cb342;">
									<div class="form-group col-md-12 main-panelbg pb-3 pt-3 pl-4">
										<h4 class="text-16 font-weight-700">{{ __('Additional Pricing Options') }}</h4>
									</div>

									<div class="col-md-12 col-xs-12 pl-3 pr-3 pl-sm-5 pr-sm-5 prop-label">
									...
									<div id="cleaning" class="{{ ( $result?->property_price?->original_cleaning_fee == 0) ? 'display-off' : '' }}">
										<div class="col-md-12 pl-3 pr-3 pl-sm-5 pr-sm-5 mt-3">
											<div class="input-group">
												<div class="input-group mb-3 prop-label">
													<div class="input-group-prepend">
									...
									<div class="col-md-12 col-xs-12 mt-4 pl-3 pr-3 pl-sm-5 pr-sm-5 prop-label">
										<label for="listing_cleaning_fee_native_checkbox" class="label-large label-inline">
									...
									<div id="additional-guests" class="{{ ($result->property_price->original_guest_fee == 0) ? 'display-off' : '' }}">
										<div class="col-md-12 pl-3 pr-3 pl-sm-5 pr-sm-5 mt-3">
											...
											<div class="input-group mt-3 prop-label">
												<label class="label-large">{{ __('For each guest after') }}</label>
											</div>

											<div class="input-group mt-3 prop-label">
												<select id="price-select-guests_included" name="guest_after" data-saving="additional-saving" class="text-16" style="width:23rem;">
													@for ($i=1;$i<=16;$i++)
									...
									<div class="col-md-12 pl-3 pr-3 pl-sm-5 pr-sm-5 mt-4 prop-label">
										<label for="listing_cleaning_fee_native_checkbox" class="label-large label-inline">
								...
								<div class="row justify-content-between mt-4 mb-5">
									<div class="mt-4">
										<a  data-prevent-default="" href="{{ url('listing/' . $result->id . '/photos') }}" class="back-btn">
											{{ __('Back') }}
										</a>
									</div>

									<div class="mt-4">
										<button type="submit" class="nxt-btn" id="btn_next"> <i class="spinner fa fa-spinner fa-spin d-none" ></i> <span id="btn_next-text">{{ __('Next') }}</span>
