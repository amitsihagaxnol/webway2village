<div class="box box-info box_info">
	<div class="panel-body">
		...
		<ul class="nav navbar-pills nav-tabs nav-stacked no-margin d-flex flex-column f-14" role="tablist">
			...
			@if (Helpers::has_permission(Auth::guard('admin')->user()->id, 'farm_type'))
				<li class="{{ (Route::current()->uri() == 'admin/settings/farm-type' || Route::current()->uri() == 'admin/settings/add-farm-type' || Route::current()->uri() == 'admin/settings/edit-farm-type/{id}') ? 'active' : ''  }}">
					<a href="{{ url('admin/settings/farm-type') }}" data-group="farm_type">Farm Type</a>
				</li>
			@endif

			@if (Helpers::has_permission(Auth::guard('admin')->user()->id, 'activity_type'))
			...
			@if (Helpers::has_permission(Auth::guard('admin')->user()->id, 'activity_type'))
				<li class="{{ (Route::current()->uri() == 'admin/settings/account-deactivation' || Route::current()->uri() == 'admin/settings/add-account-deactivation' || Route::current()->uri() == 'admin/settings/edit-account-deactivation/{id}') ? 'active' : ''  }}">
					<a href="{{ url('admin/settings/account-deactivation') }}" data-group="account_deactivation">Account Deactivation</a>
				</li>
			@endif
			...
			@if (Helpers::has_permission(Auth::guard('admin')->user()->id, 'database_backup'))
			<li class="{{ (Route::current()->uri() == 'admin/settings/room-type') ? 'active' : ''  }}">
				<a href="{{ url('admin/settings/room-type') }}"><span>Room Type</span></a>
			</li>
			@endif
		</ul>
	</div>
