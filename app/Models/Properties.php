...
class Properties extends Model
{
    ...
    {
         return $this->hasOne('App\Models\FarmHouse', 'property_id', 'id');

    }

     public function farm_facility()
    {
         return $this->hasMany('App\Models\FarmHouseFacility', 'property_id', 'id');

    }

    public function farm_activity()
    {
         return $this->hasMany('App\Models\FarmHouseActivity', 'property_id', 'id');

    }

      public function organic_product()
    {
         return $this->hasMany('App\Models\OrganicProduct', 'property_id', 'id');
    ...
    {
        return $this->hasMany('App\Models\PropertyRoomType', 'property_id', 'id');
    }

    public function farm_locations_nearby()
    {
        return $this->hasMany('App\Models\FarmHouseLocation', 'property_id', 'id');
    }


    public function farm_sustainable_practices()
    {
        return $this->hasMany('App\Models\FarmHouseSustainablePractice', 'property_id', 'id');
    }

    public function farm_house_irrigation_practice()
    {
        return $this->hasMany('App\Models\FarmHouseIrrigationMethodPractice', 'property_id', 'id');
    }

    public function farm_house_pest_disease_practice()
    {
        return $this->hasMany('App\Models\FarmHousePestDiseasePractice', 'property_id', 'id');
    }

    public function farm_house_soil_health_practice()
    {
        return $this->hasMany('App\Models\FarmHouseSoilHealthPractice', 'property_id', 'id');
    }
