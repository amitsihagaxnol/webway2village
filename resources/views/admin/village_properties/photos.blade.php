                    ...
                    <div class="box box-info">
                        <div class="box-body">
                            ...
                            <form id="img_form" enctype='multipart/form-data' method="post"
                                  action="{{ url('admin/village-listing/' . $result->id . '/' . $step) }}"
                                             ...
                                             <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    @if(isset($result->feature_image))
                                                     <img src="{{asset('public/images/village_property/feature-image/'.$result->feature_image)}}" style="width:80px; height:80px;">
                                                    @endif
                                                </div>
                                             </div>
                                ...
                                <div class="col-md-12 px-4 mt-3">
                                    <div class="col-md-10 col-sm-6 col-xs-6 l-pad-none float-start">
                                        <a data-prevent-default=""
                                           href="{{ url('admin/village-listing/' . $result->id . '/amenities') }}"
                                           class="btn btn-large btn-primary f-14">Back</a>
                                    </div>
                                    <div class="col-md-2 col-sm-6 col-xs-6 float-end text-end">
                                        <a href="{{ url('admin/village-listing/' . $result->id . '/pricing') }}"
                                           class="btn btn-large btn-primary next-section-button f-14">
                                            Next
                                        </a>
                                    </div>
