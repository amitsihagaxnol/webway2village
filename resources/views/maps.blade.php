...
<div class="at-homefilter margin-top-85" style="padding-top: 50px;">
                        ...
                        <form action="{{ url('farm_house') }}" method="GET">
                            <div class="inner-card">
                                <div class="row align-items-center">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 position-relative home-wid-bx"  style=" border-right:1px solid #7cb342;">
                                               <div style="width:100%; height:100%; background:#fff; border-radius:4px; padding:10px;">
                                                ...
                                                <div class="value_box ">
                                                    <input type="text" name="location" class="form-control v-bx-inp" placeholder="Select Location" id="cityInput" >
                                    ...
                                    <div class="col-md-2">
                                        <button type="submit" class="btn btn-main float-right n-hvr" style="width:100%;height:55px; border-radius:5px; font-size:15px; padding:0;">Search Now</button>
                                    </div>
                                </div>
                            </div>
                        </form>
    ...
    <div class="map">
            <div class="container py-5">
                <div class="row">
                    <div class="col-lg-4">
                        <div class="reserv-bx scrl" style="border: 1px solid #7cb342;">
                            <h3>Farm house</h3>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body" style="padding:0;">
                                        <div class="list-info">
                                            <div class="info">
                                                <a href="">
                                                    <h5>Misbha Home Stay-Ur Happy Place</h5>
                                                </a>
                    ...
                    <div class="col-lg-8">
                        <div class="map-bx">
                            ...
                            <iframe style="border-radius: 10px; height: 100%;" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15126400.200890439!2d67.52512733553694!3d22.24126257912837!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a5261efce66bad7%3A0xb8abb9a3c96a92a1!2sway2village!5e0!3m2!1sen!2sin!4v1705304927001!5m2!1sen!2sin" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                        </div>
                    </div>
                </div>
            </div>
